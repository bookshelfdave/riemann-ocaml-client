...
(* OASIS_START *)
(* DO NOT EDIT (digest: 214ad65ac8914fa8eb434d599b422a74) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Riemann"; "Riemann_piqi"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "riemann";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\142E—\141\tz\011\005ÌP1πµÀg‚";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
